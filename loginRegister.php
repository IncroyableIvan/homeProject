        ...
        <div class="panel-body">
          <div class="form-group">
            <div class="input-group">
              ...
              <input id="txtUser" runat="server" type="text" class="form-control" name="username" placeholder="Utilisateur" required="" />
            </div>
          </div>
          <div class="form-group">
            <div class="input-group">
              ...
              <input id="txtPassword" runat="server" type="password" class="form-control" name="password" placeholder="Mot de passe" required="" />
            </div>
          </div>
